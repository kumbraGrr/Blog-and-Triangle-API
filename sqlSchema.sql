...
CREATE TABLE `comments` (
  ...
  KEY `fkId` (`fkId`),
  CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`fkId`) REFERENCES `posts` (`id`) ON DELETE CASCADE
...
INSERT INTO `comments` VALUES (1,'I agree',1,'2019-08-30 08:44:03'),(2,'Haha I gotta try that!',3,'2019-08-30 18:26:09');
...
-- Dump completed on 2019-08-30 20:28:30
